//
//  FGroupAlbumViewController.swift
//  christyiosfirst
//
...
class FGroupAlbumViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {

    @IBOutlet weak var fgroupalbumtableview: UITableView!
    ...
    override func viewDidLoad() {
        ...
        let tab = self.tabBarController as! FGroupTabViewController
        id = tab.getid
        print("id is:\(id)")
        ...
        Alamofire.request("http://35.226.10.223/ios.php", method: .get, parameters: para).validate().responseJSON { response in
            ...
            if result.value != nil {
                ...
                self.fgroupalbumtableview.reloadData()
            }
        ...
        self.fgroupalbumtableview.tableFooterView = UIView(frame: CGRect.zero)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.fgroupalbumtableview.dequeueReusableCell(withIdentifier: "fgroupalbumcell", for: indexPath) as! FGroupAlbumTableViewCell
        ...
        //load name
        cell.fgroupalbumname.text = array[indexPath.row]["name"] as? String
            ...
            if let picpd = pic?["data"] as? [[String:Any]] {
                ...
                DispatchQueue.global().async {
                    ...
                    DispatchQueue.main.async {
                        cell.fgroupalbumpicone.image = UIImage(data: data!)
                    }
                }
                ...
                if i+1 == arraypic.count {
                    ...
                    DispatchQueue.global().async {
                        ...
                        DispatchQueue.main.async {
                            cell.fgroupalbumpictwo.image = UIImage(data:datatwo!)
                        }
                    }
                }
            }
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FGroupAlbumTableViewCell).watchFrameChanges()
    }
    func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FGroupAlbumTableViewCell).ignoreFrameChanges()
    }
    
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if indexPath as NSIndexPath == selectedIndexPath {
            return FGroupAlbumTableViewCell.expandedHeight
        }
        else {
            return FGroupAlbumTableViewCell.defaultHeight
        }
    }
