//
//  FPageAlbumViewController.swift
//  christyiosfirst
//
...
class FPageAlbumViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {

    @IBOutlet weak var fpagealbumtableview: UITableView!
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://35.226.10.223/ios.php", method: .get, parameters: para).validate().responseJSON { response in
            ...
            if result.value != nil {
                ...
                self.fpagealbumtableview.reloadData()
            }
        ...
        self.fpagealbumtableview.tableFooterView = UIView(frame: CGRect.zero)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.fpagealbumtableview.dequeueReusableCell(withIdentifier: "fpagealbumcell", for: indexPath) as! FPageAlbumTableViewCell
        ...
        //load name
        cell.fpagealbumname.text = array[indexPath.row]["name"] as? String
            ...
            if let picpd = pic?["data"] as? [[String:Any]] {
                ...
                DispatchQueue.global().async {
                    ...
                    DispatchQueue.main.async {
                        cell.fpagealbumpicone.image = UIImage(data: data!)
                    }
                }
                ...
                if i+1 == arraypic.count {
                    ...
                    DispatchQueue.global().async {
                        ...
                        DispatchQueue.main.async {
                            cell.fpagealbumpictwo.image = UIImage(data:datatwo!)
                        }
                    }
                }
            }
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FPageAlbumTableViewCell).watchFrameChanges()
    }
    func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FPageAlbumTableViewCell).ignoreFrameChanges()
    }
    
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if indexPath as NSIndexPath == selectedIndexPath {
            return FPageAlbumTableViewCell.expandedHeight
        }
        else {
            return FPageAlbumTableViewCell.defaultHeight
        }
    }
