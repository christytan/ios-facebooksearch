//
//  FPlaceAlbumViewController.swift
//  christyiosfirst
//
...
class FPlaceAlbumViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {

    @IBOutlet weak var fplacealbumtableview: UITableView!
    ...
    override func viewDidLoad() {
        ...
        let tab = self.tabBarController as! FPlaceTabViewController
        id = tab.getid
        print("id is:\(id)")
        ...
        Alamofire.request("http://35.226.10.223/ios.php", method: .get, parameters: para).validate().responseJSON { response in
            ...
            if result.value != nil {
                ...
                self.fplacealbumtableview.reloadData()
            }
        ...
        self.fplacealbumtableview.tableFooterView = UIView(frame: CGRect.zero)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.fplacealbumtableview.dequeueReusableCell(withIdentifier: "fplacealbumcell", for: indexPath) as! FPlaceAlbumTableViewCell
        ...
        //load name
        cell.fplacealbumname.text = array[indexPath.row]["name"] as? String
            ...
            if let picpd = pic?["data"] as? [[String:Any]] {
                ...
                DispatchQueue.global().async {
                    ...
                    DispatchQueue.main.async {
                        cell.fplacealbumpicone.image = UIImage(data: data!)
                    }
                }
                ...
                if i+1 == arraypic.count {
                    ...
                    DispatchQueue.global().async {
                        ...
                        DispatchQueue.main.async {
                            cell.fplacealbumpictwo.image = UIImage(data:datatwo!)
                        }
                    }
                }
            }
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FPlaceAlbumTableViewCell).watchFrameChanges()
    }
    func tableView(_ tableView: UITableView, didEndDisplaying cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        (cell as! FPlaceAlbumTableViewCell).ignoreFrameChanges()
    }
    
    
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if indexPath as NSIndexPath == selectedIndexPath {
            return FPlaceAlbumTableViewCell.expandedHeight
        }
        else {
            return FPlaceAlbumTableViewCell.defaultHeight
        }
    }
